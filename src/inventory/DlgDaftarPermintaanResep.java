...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    public DlgDaftarPermintaanResep(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Tgl.Penyerahan","Jam Penyerahan","Iterasi"
            }){
        ...
        tabMode3=new DefaultTableModel(null,new Object[]{
                "No.Resep","Tgl.Peresepan","Jam Peresepan","No.Rawat","No.RM","Pasien","Dokter Peresep",
                "Status","Kode Dokter","Ruang/Kamar","Kode Bangsal","Jenis Bayar","Tgl.Validasi","Jam Validasi","Iterasi"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){
            CrDokter.setText("");
            CrPoli.setText("");
            cmbIterasi.setSelectedItem("Semua");
            TCari.setText("");
            pilihRalan();
        }else if(TabPilihRawat.getSelectedIndex()==1){
            CrDokter2.setText("");
                    ...
                    try{  
                        ...
                        if(DEPOAKTIFOBAT.equals("")){
                            ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                                    ...
                                    " resep_obat.iterasi from resep_obat "+
                                    ...
                                    (cmbIterasi.getSelectedItem().toString().equals("Semua")?"":" and resep_obat.iterasi=? ")+
                            ...
                            if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                                while(rs.next()){
                                    ...
                                    publish(new Object[]{
                                        ...
                                        rs.getString("tgl_perawatan"),rs.getString("jam"),rs.getString("iterasi")
                                    });
                                }
                            }else{
                                while(rs.next()){
