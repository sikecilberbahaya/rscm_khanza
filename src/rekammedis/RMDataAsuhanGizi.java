...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    private String alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang, alergi_ikan, alergi_hazelnut,sttsumur="",jkPasien="";
    private String TANGGALMUNDUR="yes";
    // Field IMT/U dan status gizi (Permenkes No.2 Tahun 2020)
    private String zscore_bbperu="", zscore_tbperu="", zscore_bbpertb="", zscore_imtu="";
    private String status_bbperu="", status_tbperu="", status_bbpertb="", status_imtu="";
    ...
    public RMDataAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "ULNA(Cm)","BB Ideal(Kg)","BB/U (Z-Skor)","TB/U (Z-Skor)","BB/TB (Z-Skor)","LiLA/U (%)","IMT/U (Z-Skor)",
        ...
        for (i = 0; i < 38; i++) {
            ...
            if(i==0){
                ...
                column.setPreferredWidth(70);  // IMT/U Z-Skor
            }else if(i==18){
                column.setPreferredWidth(130); // Status BB/U
            }else if(i==19){
                column.setPreferredWidth(130); // Status TB/U
            }else if(i==20){
                column.setPreferredWidth(130); // Status BB/TB
            }else if(i==21){
                column.setPreferredWidth(130); // Status IMT/U
            }else if(i==22){
                column.setPreferredWidth(180); // Biokimia
            }else if(i==23){
                column.setPreferredWidth(180); // Fisik/Klinis
            }else if(i==24){
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 820));
        ...
        label14.setBounds(0, 790, 130, 23);
        ...
        KdPetugas.setBounds(130, 790, 130, 23);

        NmPetugas.setEditable(false);
        NmPetugas.setName("NmPetugas"); // NOI18N
        NmPetugas.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(NmPetugas);
        NmPetugas.setBounds(270, 790, 300, 23);
        ...
        BtnDokter.setBounds(570, 790, 28, 23);
        ...
        jLabel41.setBounds(0, 650, 130, 23);

        jLabel42.setText("Monitoring & Evaluasi :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 720, 130, 23);
        ...
        jLabel44.setBounds(0, 460, 130, 23);
        ...
        RiwayatPersonal.setBounds(130, 540, 645, 23);
        ...
        scrollPane3.setBounds(130, 720, 645, 63);
        ...
        scrollPane4.setBounds(130, 650, 645, 63);
        ...
        scrollPane5.setBounds(130, 580, 645, 63);
        ...
        scrollPane6.setViewportView(PolaMakan);

        FormInput.add(scrollPane6);
        scrollPane6.setBounds(130, 460, 645, 63);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("asuhan_gizi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",33,new String[]{
                    ...
                    zscore_imtu, status_bbperu, status_tbperu, status_bbpertb, status_imtu,
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        LiLAPerU.getText(),zscore_imtu,status_bbperu,status_tbperu,status_bbpertb,status_imtu,
                        Biokimia.getText(),FisikKlinis.getText(),alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang, 
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(KdPetugas.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString())){
                    hapus();
                }else{
    ...
    private void MnAsuhanGiziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAsuhanGiziActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),37).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),36).toString():finger)+"\n"+TglAsuhan.getSelectedItem());
    ...
    */
        ...
        try{
            ...
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "asuhan_gizi.antropometri_bb,asuhan_gizi.antropometri_tb,asuhan_gizi.antropometri_imt,asuhan_gizi.antropometri_lla,"+
                        "asuhan_gizi.antropometri_tl,asuhan_gizi.antropometri_ulna,asuhan_gizi.antropometri_bbideal,asuhan_gizi.antropometri_bbperu,"+
                        "asuhan_gizi.antropometri_tbperu,asuhan_gizi.antropometri_bbpertb,asuhan_gizi.antropometri_llaperu,"+
                        "COALESCE(asuhan_gizi.antropometri_imtu,'-') as antropometri_imtu,"+
                        "COALESCE(asuhan_gizi.status_bbperu,'-') as status_bbperu,COALESCE(asuhan_gizi.status_tbperu,'-') as status_tbperu,"+
                        "COALESCE(asuhan_gizi.status_bbpertb,'-') as status_bbpertb,COALESCE(asuhan_gizi.status_imtu,'-') as status_imtu,"+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("antropometri_imtu"),rs.getString("status_bbperu"),rs.getString("status_tbperu"),rs.getString("status_bbpertb"),rs.getString("status_imtu"),
    ...
    public void emptTeks() {
        zscore_bbperu=""; zscore_tbperu=""; zscore_bbpertb=""; zscore_imtu="";
        status_bbperu=""; status_tbperu=""; status_bbpertb=""; status_imtu="";
        BB.setText("");
        TB.setText("");
        IMT.setText("");
        LiLA.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            // Kolom 17=IMT/U Z-Skor, 18-21=status (hanya tampil di tabel, tidak di form input)
            zscore_imtu  = tbObat.getValueAt(tbObat.getSelectedRow(),17).toString();
            status_bbperu  = tbObat.getValueAt(tbObat.getSelectedRow(),18).toString();
            status_tbperu  = tbObat.getValueAt(tbObat.getSelectedRow(),19).toString();
            status_bbpertb = tbObat.getValueAt(tbObat.getSelectedRow(),20).toString();
            status_imtu    = tbObat.getValueAt(tbObat.getSelectedRow(),21).toString();
            Biokimia.setText(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());         
            FisikKlinis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());          
            ...
            PolaMakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            RiwayatPersonal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
            DiagnosisGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString()); 
            IntervensiGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),34).toString()); 
            Monitoring.setText(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString());
        ...
        try {
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    jkPasien = rs.getString("jk"); // L atau P
...
/**
     * Hitung IMT, Z-score (Permenkes No.2/2020), dan BB Ideal otomatis.
     *
     * Konversi umur:
     *   sttsumur = "Th"  → umur dalam tahun, kalikan 12 untuk bulan
     *   sttsumur = "Bl"  → umur sudah dalam bulan
     *
     * BB Ideal:
     *   0–60  bulan  : median BB/U dari tabel WHO
     *   5–19  tahun  : median IMT/U × (TB/100)²
     *   > 19  tahun  : Rumus Broca — L=(TB-100)×0.9 ; P=(TB-100)×0.85
     *
     * Z-score formula WHO:
     *   nilai >= median → Z = (nilai - median) / (sd_plus1 - median)
     *   nilai <  median → Z = (nilai - median) / (median - sd_minus1)
     */
    private void isBMI(){
        if((!TB.getText().equals(""))&&(!BB.getText().equals(""))){
            try {
                double bb = Valid.SetAngka(BB.getText());
                double tb = Valid.SetAngka(TB.getText());
                double tbM = tb / 100.0;
                IMT.setText(Valid.SetAngka8(bb / (tbM * tbM), 1) + "");
            } catch (Exception e) {
                IMT.setText("");
            }
            ...
            try {
                double bb = Valid.SetAngka(BB.getText());
                double tb = Valid.SetAngka(TB.getText());
                // Gunakan JK dari field jika jkPasien belum terisi
                String jkRaw = (!jkPasien.isEmpty()) ? jkPasien : Jk.getText();
                String jkKode = jkRaw.startsWith("L") ? "L" : "P";

                // Konversi umur ke bulan
                int umurBulan = 0;
                if(umur > 0){
                    umurBulan = sttsumur.equals("Th") ? umur * 12 : umur;
                }

                // --- BB/U (0-60 bulan) ---
                if(umurBulan > 0 && umurBulan <= 60){
                    double z = hitungZskorDB("BB/U", jkKode, umurBulan, 0, bb);
                    zscore_bbperu = Valid.SetAngka8(z, 2) + "";
                    BBPerU.setText(zscore_bbperu);
                    status_bbperu = kategoriZscoreBBU(z);
                ...
                // --- TB/U (0-60 bulan) ---
                if(umurBulan > 0 && umurBulan <= 60){
                    int isPanjang = (umurBulan < 24) ? 1 : 0;
                    double z = hitungZskorDB("TB/U", jkKode, umurBulan, isPanjang, tb);
                    zscore_tbperu = Valid.SetAngka8(z, 2) + "";
                    TBPerU.setText(zscore_tbperu);
                    status_tbperu = kategoriZscoreTBU(z);
                } else if(umurBulan > 60){
                    TBPerU.setText("-");
                    status_tbperu = "-";
                }

                // --- BB/TB (0-60 bulan, lookup berdasarkan tinggi badan) ---
                if(umurBulan > 0 && umurBulan <= 60){
                    // Kunci lookup: tinggi badan dibulatkan ke cm terdekat, lalu × 10
                    int tbKeyRounded = (int)(Math.round(tb) * 10);
                    if(tbKeyRounded < 450) tbKeyRounded = 450;
                    if(tbKeyRounded > 1200) tbKeyRounded = 1200;
                    // is_panjang ditentukan dari TINGGI badan:
                    //   45–86 cm (key 450–860) = is_panjang=1 (panjang badan / telentang)
                    //   87–120 cm (key 870–1200) = is_panjang=0 (tinggi badan / berdiri)
                    int isPanjang = (tbKeyRounded <= 860) ? 1 : 0;
                    double[] refRow = cariRefBBTB(jkKode, tbKeyRounded, isPanjang);
                    if(refRow != null){
                        double sdMinus1 = refRow[0], median = refRow[1], sdPlus1 = refRow[2];
                        double zDisplay, zSigned;
                        if(bb >= median){
                            // BB >= median: (BB - median) / (sdPlus1 - median)
                            double sd = sdPlus1 - median;
                            zDisplay = (sd > 0) ? (bb - median) / sd : 0;
                            zSigned  = zDisplay;
                        } else {
                            // BB < median: (median - BB) / (median - sdMinus1)
                            double sd = median - sdMinus1;
                            zDisplay = (sd > 0) ? (median - bb) / sd : 0;
                            zSigned  = -zDisplay;
                        }
                        zscore_bbpertb = Valid.SetAngka8(zDisplay, 2) + "";
                        BBPerTB.setText(zscore_bbpertb);
                        status_bbpertb = kategoriZscoreBBTB(zSigned);
                    } else {
                        BBPerTB.setText("-");
                        status_bbpertb = "-";
                        System.out.println("BB/TB ref not found: jk=" + jkKode + " key=" + tbKeyRounded + " isPanjang=" + isPanjang);
                    }
                } else if(umurBulan > 60){
                    BBPerTB.setText("-");
                    status_bbpertb = "-";
                ...
                // --- IMT/U (60-228 bulan / 5-19 tahun) ---
                if(umurBulan >= 60 && umurBulan <= 228){
                    double tbM = tb / 100.0;
                    double imt = bb / (tbM * tbM);
                    int umurKeyIMTU = cariUmurFloorIMTU(jkKode, umurBulan);
                    if(umurKeyIMTU > 0){
                        double z = hitungZskorDB("IMT/U", jkKode, umurKeyIMTU, 0, imt);
                        zscore_imtu = Valid.SetAngka8(z, 2) + "";
                        status_imtu = kategoriZscoreIMTU(z);
                    }
                } else if(umurBulan > 228 || umurBulan == 0){
                    zscore_imtu = "-";
                    status_imtu = "-";
                }
                ...
                double bbIdeal = 0;
                if(umurBulan > 0 && umurBulan <= 60){
                    // Anak 0-5 tahun: median BB/TB (BB ideal untuk tinggi tertentu)
                    int tbKeyBBI = (int)(Math.round(tb) * 10);
                    if(tbKeyBBI < 450) tbKeyBBI = 450;
                    if(tbKeyBBI > 1200) tbKeyBBI = 1200;
                    int isPanjangBBI = (tbKeyBBI <= 860) ? 1 : 0;
                    double[] refBBI = cariRefBBTB(jkKode, tbKeyBBI, isPanjangBBI);
                    if(refBBI != null) bbIdeal = refBBI[1]; // index 1 = median
                } else if(umurBulan > 60 && umurBulan <= 228){
                    // Remaja 5-19 tahun: BB Ideal = median IMT/U × (TB/100)²
                    int umurKeyIMTU = cariUmurFloorIMTU(jkKode, umurBulan);
                    if(umurKeyIMTU > 0){
                        double medianIMT = hitungMedianDB("IMT/U", jkKode, umurKeyIMTU, 0);
                        if(medianIMT > 0){
                            bbIdeal = medianIMT * (tb / 100.0) * (tb / 100.0);
                        }
                    }
                } else {
                    // Dewasa (> 19 tahun atau umur tidak diketahui): Rumus Broca
                    if(jkKode.equals("L")){
                        bbIdeal = (tb - 100.0) * 0.9;
                    } else {
                        bbIdeal = (tb - 100.0) * 0.85;
                    }
                }
                if(bbIdeal > 0){
                    BBIdeal.setText(Valid.SetAngka8(bbIdeal, 1) + "");
                }

            } catch (Exception ex) {
                System.out.println("isBMI error: " + ex);
            }
        }
    }

    /**
     * Cari referensi BB/TB dari database menggunakan floor lookup (umur ≤ tbKey).
     * Mengembalikan array [sd_minus1, median, sd_plus1] atau null jika tidak ditemukan.
     * Formula tampil: BB>=median → (BB-median)/(sdPlus1-median), BB<median → (median-BB)/(median-sdMinus1)
     */
    private double[] cariRefBBTB(String jkKode, int tbKey, int isPanjang){
        PreparedStatement ps2 = null;
        ResultSet rs2 = null;
        try {
            ps2 = koneksi.prepareStatement(
                "SELECT sd_minus1, median, sd_plus1 FROM ref_antropometri_who "
                + "WHERE indikator='BB/TB' AND jk=? AND is_panjang=? AND umur<=? "
                + "ORDER BY umur DESC LIMIT 1");
            ps2.setString(1, jkKode);
            ps2.setInt(2, isPanjang);
            ps2.setInt(3, tbKey);
            rs2 = ps2.executeQuery();
            if(rs2.next()){
                return new double[]{ rs2.getDouble("sd_minus1"), rs2.getDouble("median"), rs2.getDouble("sd_plus1") };
            }
        } catch(Exception e){
            System.out.println("cariRefBBTB error: " + e);
        } finally {
    ...
    /**
     * Cari umur floor (≤ umurBulan) yang tersedia di tabel IMT/U via DB.
     * Mengembalikan 0 jika tidak ditemukan.
     */
    private int cariUmurFloorIMTU(String jkKode, int umurBulan){
        int key = 0;
        PreparedStatement ps2 = null;
        ResultSet rs2 = null;
        try {
            ps2 = koneksi.prepareStatement(
                "SELECT umur FROM ref_antropometri_who "
                + "WHERE indikator='IMT/U' AND jk=? AND umur<=? "
                + "ORDER BY umur DESC LIMIT 1");
            ps2.setString(1, jkKode);
            ps2.setInt(2, umurBulan);
            rs2 = ps2.executeQuery();
            if(rs2.next()){
                key = rs2.getInt("umur");
            }
        } catch(Exception e){
            System.out.println("cariUmurFloorIMTU error: " + e);
        } finally {
            try { if(rs2 != null) rs2.close(); } catch(Exception e){}
            try { if(ps2 != null) ps2.close(); } catch(Exception e){}
        }
    ...
    /**
     * Ambil nilai median dari tabel referensi WHO.
     */
    private double hitungMedianDB(String indikator, String jk, int umurKey, int isPanjang){
        double median = 0;
        PreparedStatement ps2 = null;
        ResultSet rs2 = null;
        try {
            ps2 = koneksi.prepareStatement(
                "SELECT median FROM ref_antropometri_who "
                + "WHERE indikator=? AND jk=? AND umur=? AND is_panjang=?");
            ps2.setString(1, indikator);
            ps2.setString(2, jk);
            ps2.setInt(3, umurKey);
            ps2.setInt(4, isPanjang);
            rs2 = ps2.executeQuery();
            if(rs2.next()){
                median = rs2.getDouble("median");
            }
        } catch(Exception e){
            System.out.println("hitungMedianDB error: " + e);
        } finally {
            try { if(rs2 != null) rs2.close(); } catch(Exception e){}
            try { if(ps2 != null) ps2.close(); } catch(Exception e){}
        }
    ...
    /**
     * Ambil nilai SD dari database dan hitung Z-score.
     * Menggunakan rumus LMS / SD WHO:
     *   Z = (nilai - median) / SD_plus  jika nilai >= median
     *   Z = (nilai - median) / SD_minus jika nilai <  median
     */
    private double hitungZskorDB(String indikator, String jk, int umurKey, int isPanjang, double nilaiAnak) {
        double z = 0;
        PreparedStatement ps2 = null;
        ResultSet rs2 = null;
        try {
            ...
            rs2 = ps2.executeQuery();
            if(rs2.next()){
                double median   = rs2.getDouble("median");
                double sdMinus1 = rs2.getDouble("sd_minus1");
                double sdPlus1  = rs2.getDouble("sd_plus1");
                if(nilaiAnak >= median){
                    double sd = sdPlus1 - median;
                    z = (sd != 0) ? (nilaiAnak - median) / sd : 0;
                } else {
                    double sd = median - sdMinus1;
                    z = (sd != 0) ? (nilaiAnak - median) / sd : 0;
                }
            ...
            System.out.println("hitungZskorDB error: " + e);
        } finally {
            try { if(rs2 != null) rs2.close(); } catch(Exception e){}
            try { if(ps2 != null) ps2.close(); } catch(Exception e){}
        }
    ...
    /** Kategori BB/U (Permenkes No.2/2020) */
    private String kategoriZscoreBBU(double z){
        if(z < -3)       return "Berat badan sangat kurang";
        else if(z < -2)  return "Berat badan kurang";
        else if(z <= 1)  return "Berat badan normal";
        else             return "Risiko berat badan lebih";
    }

    /** Kategori TB/U (Permenkes No.2/2020) */
    private String kategoriZscoreTBU(double z){
        if(z < -3)       return "Sangat pendek";
        else if(z < -2)  return "Pendek";
        else if(z <= 3)  return "Normal";
        else             return "Tinggi";
    }

    /** Kategori BB/TB atau BB/PB (Permenkes No.2/2020) */
    private String kategoriZscoreBBTB(double z){
        if(z < -3)       return "Gizi buruk";
        else if(z < -2)  return "Gizi kurang";
        else if(z <= 1)  return "Gizi baik";
        else if(z <= 2)  return "Berisiko gizi lebih";
        else if(z <= 3)  return "Gizi lebih";
        else             return "Obesitas";
    }

    /** Kategori IMT/U 5-19 tahun (Permenkes No.2/2020) */
    private String kategoriZscoreIMTU(double z){
        if(z < -3)       return "Gizi buruk";
        else if(z < -2)  return "Gizi kurang";
        else if(z <= 1)  return "Gizi baik";
        else if(z <= 2)  return "Berisiko gizi lebih";
    ...
    private void ganti() {
        ...
        if(Sequel.mengedittf("asuhan_gizi","no_rawat=? and tanggal=?","no_rawat=?,tanggal=?,antropometri_bb=?,antropometri_tb=?,antropometri_imt=?,antropometri_lla=?,antropometri_tl=?,antropometri_ulna=?,antropometri_bbideal=?,antropometri_bbperu=?,antropometri_tbperu=?,antropometri_bbpertb=?,antropometri_llaperu=?,antropometri_imtu=?,status_bbperu=?,status_tbperu=?,status_bbpertb=?,status_imtu=?,biokimia=?,fisik_klinis=?,alergi_telur=?,alergi_susu_sapi=?,alergi_kacang=?,alergi_gluten=?,alergi_udang=?,alergi_ikan=?,alergi_hazelnut=?,pola_makan=?,riwayat_personal=?,diagnosis=?,intervensi_gizi=?,monitoring_evaluasi=?,nip=?",35,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+""),BB.getText(),TB.getText(),IMT.getText(),LiLA.getText(), 
                TL.getText(),ULNA.getText(),BBIdeal.getText(),BBPerU.getText(),TBPerU.getText(),BBPerTB.getText(),LiLAPerU.getText(),
                zscore_imtu, status_bbperu, status_tbperu, status_bbpertb, status_imtu,
                Biokimia.getText(),FisikKlinis.getText(), alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang, 
                ...
                tbObat.setValueAt(zscore_imtu,tbObat.getSelectedRow(),17);
                tbObat.setValueAt(status_bbperu,tbObat.getSelectedRow(),18);
                tbObat.setValueAt(status_tbperu,tbObat.getSelectedRow(),19);
                tbObat.setValueAt(status_bbpertb,tbObat.getSelectedRow(),20);
                tbObat.setValueAt(status_imtu,tbObat.getSelectedRow(),21);
                tbObat.setValueAt(Biokimia.getText(),tbObat.getSelectedRow(),22);
                tbObat.setValueAt(FisikKlinis.getText(),tbObat.getSelectedRow(),23);
                tbObat.setValueAt(alergi_telur,tbObat.getSelectedRow(),24);
                tbObat.setValueAt(alergi_susu_sapi,tbObat.getSelectedRow(),25);
                tbObat.setValueAt(alergi_kacang,tbObat.getSelectedRow(),26);
                tbObat.setValueAt(alergi_gluten,tbObat.getSelectedRow(),27);
                tbObat.setValueAt(alergi_udang,tbObat.getSelectedRow(),28);
                tbObat.setValueAt(alergi_ikan,tbObat.getSelectedRow(),29);
                tbObat.setValueAt(alergi_hazelnut,tbObat.getSelectedRow(),30);
                tbObat.setValueAt(PolaMakan.getText(),tbObat.getSelectedRow(),31);
                tbObat.setValueAt(RiwayatPersonal.getText(),tbObat.getSelectedRow(),32);
                tbObat.setValueAt(DiagnosisGizi.getText(),tbObat.getSelectedRow(),33);
                tbObat.setValueAt(IntervensiGizi.getText(),tbObat.getSelectedRow(),34);
                tbObat.setValueAt(Monitoring.getText(),tbObat.getSelectedRow(),35);
                tbObat.setValueAt(KdPetugas.getText(),tbObat.getSelectedRow(),36);
                tbObat.setValueAt(NmPetugas.getText(),tbObat.getSelectedRow(),37);
                emptTeks();
        }
    }
