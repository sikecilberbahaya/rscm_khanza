...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnLaporanKuretase = new javax.swing.JMenuItem();
        ...
        MnLaporanKuretase.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanKuretase.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanKuretase.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanKuretase.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanKuretase.setText("Laporan Kuretase");
        MnLaporanKuretase.setName("MnLaporanKuretase"); // NOI18N
        MnLaporanKuretase.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanKuretase.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanKuretaseActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanKuretase);
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
    ...
    private void MnLaporanKuretaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanKuretaseActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                Map<String, Object> param = new HashMap<>();    
                param.put("namars",akses.getnamars());
                ...
                Valid.MyReport("rptLaporanKuretase.jasper","report","::[ Laporan Kuretase ]::",param);
            }else{
                JOptionPane.showMessageDialog(rootPane,"Silahkan pilih data, klik pada No.Rawat ..!!");
            } 
        }
    }//GEN-LAST:event_MnLaporanKuretaseActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnLaporanKuretase;
