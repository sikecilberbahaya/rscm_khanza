    ...
    try {
        ...
        if (bedawaktu < 0) {
            ...
            int pilihan = JOptionPane.showConfirmDialog(
                null,
                "PERINGATAN!\n\n" +
                "Tanggal input data lebih awal dari tanggal registrasi!\n" +
                "Tanggal registrasi: " + tanggalregistrasi + "\n\n" +
            ...
            // Jika pilih YES, set true, jika NO tetap false
        ...
        try {
            ...
            if (bedawaktu > 172800) {
                ...
                int pilihan = JOptionPane.showConfirmDialog(
                    null,
                    "PERINGATAN!\n\n" +
                    "Perubahan/penghapusan data sudah melebihi batas waktu 48 jam!\n" +
                    "Waktu yang telah berlalu: " + (bedawaktu / 3600) + " jam\n\n" +
                    "Apakah Anda yakin ingin melanjutkan?",
                    "Konfirmasi Batas Waktu",
                    JOptionPane.YES_NO_OPTION,
                    JOptionPane.WARNING_MESSAGE
                );
