            ...
            if(tbObat.getValueAt(i,0).toString().equals("true")&&(!tbObat.getValueAt(i,5).toString().equals(""))&&(!tbObat.getValueAt(i,6).toString().equals(""))&&(!tbObat.getValueAt(i,9).toString().equals(""))&&tbObat.getValueAt(i,11).toString().equals("")){
                try {
                    ...
                    try{
                        ...
                        String isiDiet = tbObat.getValueAt(i,7).toString();

                        // default jika kosong
                        if(isiDiet == null || isiDiet.trim().equals("")){
                            isiDiet = "Tidak ada catatan diet";
                        }

                        // 🔥 HAPUS ENTER
                        isiDiet = isiDiet.replace("\n", " ").replace("\r", " ");

                        // 🔥 ESCAPE QUOTE
                        isiDiet = isiDiet.replace("\"", "\\\"");

                        // 🔥 FORMAT XHTML (FHIR wajib)
                        isiDiet = "<div xmlns=\\\"http://www.w3.org/1999/xhtml\\\">" + isiDiet + "</div>";
                        json = "{" +
